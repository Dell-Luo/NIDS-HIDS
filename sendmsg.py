...
def send(msg):
    ...
    prefix = 'https://oapi.dingtalk.com/robot/send?access_token=b60feb7e9d75c865644f73c56c2299bc5ed583ec80a8cf1b604db767d2e936a7'# 这里替换为复制的完整 webhook 地址,从钉钉群里生成机器人的时候复制
